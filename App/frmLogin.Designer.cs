namespace AppBase
{
    partial class frmLogin
    {
        ...
        private void InitializeComponent()
        {
            ...
            lb_sistema_no_disponible = new Label();
            lb_usuario_baja = new Label();
            SuspendLayout();
            // 
            // lbl_Email
            // 
            ...
            lbl_Email.Tag = "lb_Usuario";
            lbl_Email.Text = "Usuario";
            // 
            // txt_Email
            // 
            txt_Email.Location = new Point(96, 22);
            txt_Email.Name = "txt_Email";
            txt_Email.Size = new Size(261, 23);
            ...
            // 
            // lb_sistema_no_disponible
            // 
            lb_sistema_no_disponible.AutoSize = true;
            lb_sistema_no_disponible.Location = new Point(363, 154);
            lb_sistema_no_disponible.Name = "lb_sistema_no_disponible";
            lb_sistema_no_disponible.Size = new Size(254, 30);
            lb_sistema_no_disponible.TabIndex = 10;
            lb_sistema_no_disponible.Tag = "lb_sistema_no_disponible";
            lb_sistema_no_disponible.Text = "El sistema no está disponible en este momento\r\nContacte con un Administrador.";
            lb_sistema_no_disponible.Visible = false;
            // 
            // lb_usuario_baja
            // 
            lb_usuario_baja.AutoSize = true;
            lb_usuario_baja.Location = new Point(363, 190);
            lb_usuario_baja.Name = "lb_usuario_baja";
            lb_usuario_baja.Size = new Size(119, 15);
            lb_usuario_baja.TabIndex = 11;
            lb_usuario_baja.Tag = "lb_usuario_baja";
            lb_usuario_baja.Text = "Usuario Dado de Baja";
            lb_usuario_baja.Visible = false;
            // 
            // frmLogin
            // 
            AutoScaleDimensions = new SizeF(7F, 15F);
            AutoScaleMode = AutoScaleMode.Font;
            ClientSize = new Size(567, 233);
            Controls.Add(lb_usuario_baja);
            Controls.Add(lb_sistema_no_disponible);
        ...
        private Label lb_sistema_no_disponible;
        private Label lb_usuario_baja;
    }
}